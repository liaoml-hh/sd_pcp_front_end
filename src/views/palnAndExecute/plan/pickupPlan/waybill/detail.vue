<template>
  ...
  >
    ...
    <el-table-column label="订单号" sortable prop="orderNo" width="110" show-overflow-tooltip align="center">
      <template slot-scope="{ row }">
    ...
    <el-table-column label="客户" prop="customer" width="90" show-overflow-tooltip align="center" />
    <el-table-column label="仓库地址" prop="warehouseAddress" width="100" align="center" />
    <el-table-column label="状态" prop="status" width="69" align="center">
      <template slot-scope="{row}">
        <span>
          {{
    ...
    <el-table-column label="收货人" prop="receiver" width="60" align="center" show-overflow-tooltip />
    ...
    <el-table-column label="下单时间" show-overflow-tooltip width="104" prop="placeBillwayTime" align="center" />
    <!-- <el-table-column label="起始城市" prop="startCity" width="120" /> -->
    <!-- <el-table-column label="目的城市" show-overflow-tooltip prop="goalCity" align="center" width="130" /> -->
    <el-table-column label="目的县区" show-overflow-tooltip prop="goalCounty" width="130" align="center" />
    <el-table-column label="目的地址" show-overflow-tooltip prop="goalAddress" align="center" width="110" />
    <el-table-column label="货品" prop="goods" show-overflow-tooltip width="70" align="center" />
    <el-table-column label="货品类型" prop="goodsTypeShortName" show-overflow-tooltip width="80" align="center" />
    <el-table-column label="箱数" prop="quantity" width="60" align="center" />
    <el-table-column label="未提箱数" prop="stock" width="60" align="center">
      <template slot-scope="{row}">
        <span>
    ...
    <el-table-column label="计价方式" prop="dictionarycostway.value" width="80" align="center" />
