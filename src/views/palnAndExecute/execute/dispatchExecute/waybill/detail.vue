<template>
  ...
  <el-table
    ...
    :cell-style="rowClass"
    style="margin:0 0 0 49px;width:99%"
    :row-class-name="tableRowClassName"
  ...
  >
    ...
    <el-table-column label="仓库地址" show-overflow-tooltip prop="warehouseAddress" width="100" align="center" />
    ...
    <el-table-column label="收货人" prop="receiverCompany" width="80" show-overflow-tooltip align="center" />
    ...
    <el-table-column label="下单时间" prop="placeBillwayTime" show-overflow-tooltip width="110" align="center" />
    ...
    <el-table-column label="货品类型" show-overflow-tooltip prop="goodsTypeShortName" width="75" align="center" />
