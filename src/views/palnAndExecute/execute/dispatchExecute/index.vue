<template>
  <div>
    ...
    <!--查询框 -->
    <div>
      <el-form :inline="true" size="mini" :label-position="'right'" label-width="90px" :model="searchForm">
        <el-col :span="4">
          <el-form-item label="配送单号" label-position="right">
            <el-input v-model="searchForm.dispatchBillNo" clearable />
          </el-form-item>
          <el-form-item label="调度员">
            <el-input v-model="searchForm.dispatcher" clearable />
          </el-form-item>
        </el-col>
        <el-col :span="4">
          <el-form-item label="司机">
            <el-select v-model="searchForm.driverId" filterable clearable placeholder="请选择">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item label="配送类型" style="margin-left:1.8%">
            <el-select v-model="searchForm.dispatchType" clearable placeholder="请选择" size="mini">
              <el-option
        ...
        <el-col :span="4">
          <el-form-item label="执行状态">
            <el-input v-model="searchForm.billStatus" clearable />
          </el-form-item>
          <el-form-item label="始发地">
            <el-select v-model="searchForm.startStation" clearable>
              <el-option
        ...
        <el-col :span="5">
          <el-form-item label="目的地" label-width="110px">
            <el-select v-model="searchForm.goalStation" style="width:230px" clearable size="mini">
              <el-option
        ...
        <el-col :span="2" style="margin-top:2.8%">
          <el-form-item label="">
    ...
    >
      ...
      <el-table-column label="配送单号" prop="dispatchBillNo" width="110" show-overflow-tooltip />
      <!-- <el-table-column label="运单号" prop="waybillNo" width="100" show-overflow-tooltip /> -->
      <el-table-column label="配送批次" prop="dispatchBatchNo" width="110" show-overflow-tooltip />
      <el-table-column label="调度员" prop="dispatcher" width="68" show-overflow-tooltip />
      <el-table-column label="调度员电话" prop="tel" width="108" show-overflow-tooltip />
      <el-table-column label="司机" prop="driver" width="68" show-overflow-tooltip />
      <el-table-column label="车辆" prop="car" width="86" show-overflow-tooltip />
      <el-table-column prop="billStatus" sortable label="运单状态" width="100" align="center">
        ...
        <template slot-scope="{ row }">
          ...
          <img v-show=" parseInt(row.billStatus) === 2" :src="statusAcceptImgSrc" width="40%" style="position:absolute;top:37%;right:72%;width:15px;height:15px;">
          <img v-show=" parseInt(row.billStatus) === 0" :src="statusRejectImgSrc" width="40%" style="position:absolute;top:37%;right:72%;width:16px;height:16px;">
          <span>
            {{
              parseInt(row.billStatus) === 1
                ? '未接收'
      ...
      <el-table-column label="目的地" prop="goalStation" width="60" show-overflow-tooltip />
      <el-table-column label="始发地" prop="startStation" width="60" show-overflow-tooltip />
      <el-table-column prop="allocationDTO.name" label="分拨点" width="90" show-overflow-tooltip align="center" />
      <el-table-column prop="dispatchType" label="配送类型" width="78" show-overflow-tooltip align="center">
        <template slot-scope="{row}">
          <span>
            {{
      ...
      <el-table-column label="分公司" prop="companyDTO.name" width="88" show-overflow-tooltip />
      <el-table-column label="预约配送时间" prop="preSendTime" width="100" />
      <el-table-column prop="createdTime" sortable label="业务时间" width="100" align="center" />
      <el-table-column prop="urgentDegree" label="紧急程度" width="76" show-overflow-tooltip align="center">
        <template slot-scope="{row}">
          <span>
            {{
              row.urgentDegree === '1'
      ...
      <el-table-column label="操作时间" prop="operateTime" width="100" align="center" />
      <el-table-column label="司机当前位置" prop="businessAddress" show-overflow-tooltip align="center" />
    </el-table>
    <div class="block">
      <el-pagination
