<template>
  ...
  >
    ...
    <el-table-column label="源头单号" sortable prop="sourceOrderNo" width="140" show-overflow-tooltip align="center">
    ...
    <el-table-column label="订单号" sortable prop="orderNo" width="149" show-overflow-tooltip align="center">
      <template slot-scope="{ row }">
    ...
    <el-table-column label="仓库地址" prop="warehouseAddress" width="110" align="center" show-overflow-tooltip />
    <el-table-column label="状态" prop="status" width="70" show-overflow-tooltip align="center">
      <template slot-scope="{row}">
        <span>
          {{
    ...
    <el-table-column label="收货人" prop="receiver" width="70" show-overflow-tooltip align="center" />
    ...
    <el-table-column label="下单时间" show-overflow-tooltip prop="placeBillwayTime" width="110" align="center" />
    ...
    <el-table-column label="目的县区" show-overflow-tooltip prop="goalCounty" width="90" align="center" />
    <el-table-column label="目的地址" show-overflow-tooltip prop="goalAddress" width="100" align="center" />
    <!-- <el-table-column label="上游单号" prop="upstreamOrderNo" width="150" show-overflow-tooltip /> -->
    <el-table-column label="货品" prop="goods" width="80" show-overflow-tooltip align="center" />
    <el-table-column label="货品类型" width="80" prop="goodsTypeShortName" show-overflow-tooltip align="center" />
    <el-table-column label="箱数" width="60" prop="quantity" show-overflow-tooltip align="center" />
    <el-table-column label="体积" width="60" prop="cubage" show-overflow-tooltip align="center" />
    <el-table-column label="重量" width="60" prop="weight" show-overflow-tooltip align="center" />
    <el-table-column label="计价方式" width="80" prop="dictionarycostway.value" show-overflow-tooltip align="center" />
    <el-table-column label="回单份数" width="80" prop="signDocumentNum" show-overflow-tooltip align="center" />
