<template>
  <div class="main_box" :style="`height:${boxHeight}px`">
    ...
    <div class="left_nav">
      <el-row>
        <div class="left_nav_top">
          <div>
            ...
            <dv-border-box-8>
              <div class="left_nav_top_name">1,423,92度</div>
              <div class="left_nav_top_value">累计换电度数</div>
            </dv-border-box-8>

          </div>
          <div>
            <dv-border-box-8>
              <div class="left_nav_top_name">3392吨</div>
              <div class="left_nav_top_value">减少碳排放量</div>
            </dv-border-box-8>
          </div>
        </div>
      </el-row>
      <el-row>
        <div>
          <div id="OverYearsPompanyChart" style="width:250%; height:230%;margin-left:0px" />
        </div>
      </el-row>
      <el-row>
        <div>
          <dv-border-box-11 style="height:400px">
            <!-- <dv-charts :option="option" /> -->

            <div id="stationHistoricalData" style="width: 350px; height:250px;margin-top:100px" />
            <div id="stationHistoricalData_buttom" style="width:200px;height:75px;margin-left:20px" />
          </dv-border-box-11>
          <!--
    ...
    <div class="center">
      <el-row :span="8">
        ...
        <dv-border-box-8 style="margin-top:30px" :reverse="true">
          <div class="center_top">
            <div>
              <div class="center_top_name">累计收入数据</div>
              <div class="center_top_value">{{ totalincome }}</div>
              <div class="center_top_unit">元</div>
            </div>
            <div>
              <div class="center_top_name">当日收入数据</div>
              <div class="center_top_value">{{ todayincome }}</div>
              <div class="center_top_unit">元</div>
            </div>
          </div>
        </dv-border-box-8>
      ...
      <!-- <el-row :span="8">
        <dv-flyline-chart :config="config" style="width:500px;height:500px;" />
      </el-row> -->
      <el-row :span="12">
        <!-- <my-map /> --><div />
      </el-row>
    ...
    <div class="right_nav">
      <el-row>
        <div id="stationdistribute" style="height:200px;width:200px" />
      </el-row>
      <el-row>
        <div class="right_nav_center">
          <dv-border-box-11 style="width:300px;height: 200px;" :title-width="150" title="换电流量">
            <div style="width:100%;height:100%;margin-top:80px;margin-left:80px">
              <!-- <h4 style="color:#C0C1CD">换电量客流</h4> -->
              <div style="height:30px"><span style="color:#9596A1;font-size:13px;">今日换电流量</span>   <span style="color:#F7D878;font-size:15px;">  {{ todayappointment }}</span>     <span style="color:#01D9F8;font-size:13px;">次</span></div>
              <div style="height:30px"><span style="color:#9596A1;font-size:13px;">今日预约量</span>         <span style="color:#F7D878;font-size:15px;"> {{ todayreserved }}</span>      <span style="color:#01D9F8;font-size:13px;">次</span></div>
              <div style="height:30px"><span style="color:#9596A1;font-size:13px;">上周换电总量</span>       <span style="color:#F7D878;font-size:15px;"> {{ lastweekmount }}</span>    <span style="color:#01D9F8;font-size:13px;">次</span></div>
            </div>
          </dv-border-box-11>
          <div id="myChartedSpeed" style="width: 180px;height: 180px ;margin-bottom:6px;" />
        </div>
      </el-row>
      <el-row :span="8">
        <div class="mychart">
          <div id="userdistribute" style="width:350px; height:250px" />
        </div>
      </el-row>
    </div>
  </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      config: {
        ...
        bgImgUrl: '../../assets/404_images/bg.jpg'
      }
    }
  },
  // 计算属性 类似于data概念
  ...
  methods: {
    ...
    stationdistribute() {
      ...
      var myChart = echarts.init(document.getElementById('stationdistribute'))
      // 绘制图表
    ...
    userdistribute() {
      // 基于准备好的dom，初始化echarts实例
      const myChart = this.$echarts.init(document.getElementById('userdistribute'))
      // 绘制图表
      myChart.setOption({
        title: { text: '用户数量' },
        tooltip: {},
...
.pie{
  margin-top:35px;
       ...
       .main_box{
            width: 100%;
            height: 900px;
            background-color: rgb(8, 12, 60);
            display: flex;
            justify-content: space-around;
            background-image: url("./8171e2bd81c24179d5728b7c7037512.png");
