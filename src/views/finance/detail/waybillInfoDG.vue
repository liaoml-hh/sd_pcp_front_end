<template>
  <div>
        ...
        <el-collapse-transition>
          <div v-show="showCard">
            <el-row>
              ...
              <el-col :span="6">
                <el-form-item label="货品类型" prop="goodsTypeShortName" label-width="88px">
                  <el-col :span="22">
              ...
              <el-col :span="6">
                <el-form-item label="费用" prop="waybillCharges" label-width="88px">
                  <el-col :span="22">
                    <el-input v-model="formData.waybillCharges" placeholder="0" />
                  </el-col>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                <el-form-item label="公司成本" prop="waybillCost" label-width="88px">
                  <el-col :span="22">
                    <el-input v-model="formData.waybillCost" placeholder="0" />
                  </el-col>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                ...
                <el-form-item label="应收" prop="waybillCharges">
                  <el-col :span="22">
                    <el-input v-model="formData.free.Charge" placeholder="0" disabled />
                  </el-col>
                </el-form-item>
              </el-col>
              <el-col :span="6">
                ...
                <el-form-item label="应付" prop="waybillCost">
                  <el-col :span="22">
                    <el-input v-model="formData.free.SendCost" placeholder="0" disabled />
                  </el-col>
                </el-form-item>
              </el-col>
              <el-col :span="6">
      ...
      <el-tabs type="border-card" style="width:100%">
          ...
          <el-row>
            <el-col :span="6">
              <el-form-item label="客户" prop="customer" label-width="90px">
                <el-col :span="22">
                  <el-select v-model="formData.customer" :disabled="readonly" filterable clearable @change="changeGetCount">
                    <el-option
        ...
        <el-tab-pane label="收货信息">
          <el-row>
            ...
            <el-col :span="12">
              <el-form-item label="收货人联系电话" prop="receiverMobile" label-width="110px">
                <el-col :span="22">
        ...
        <el-tab-pane v-if="readonly" label="费用信息">
          ...
          <el-row v-for="(item,index) in waybillChargeInfo" :key="index" style="margin-left:0%" @mouseenter.native="handleShowRemove(index)">
            <el-col v-for="(itemInfo,indexInfo) in item" :key="indexInfo" :span="6" style="margin-left:50px">
              <el-form-item :label="itemInfo.label" :prop="itemInfo[itemInfo.value]?itemInfo[itemInfo.value].toString():itemInfo[itemInfo.value]" label-width="70px">
                <el-select v-if="itemInfo.value === 'rateType'" v-model="itemInfo[itemInfo.value]" filterable clearable>
                  <el-option
            ...
            <el-button v-if="index === showRemoveBtn" icon="el-icon-circle-close" circle size="mini" style="border:0px;margin-left:10px" @click="removeChargeInfo(item)" />
          </el-row>
        </el-tab-pane>
        <el-tab-pane v-if="readonly" label="成本信息">
          ...
          <el-row v-for="(item,index) in waybillSendCostInfo" :key="index" @mouseenter.native="handleShowRemove(index)">
            <el-col v-for="(itemInfo,indexInfo) in item" :key="indexInfo" :span="6" style="margin-left:30px">
              <el-form-item :label="itemInfo.label" :prop="itemInfo[itemInfo.value]?itemInfo[itemInfo.value].toString():itemInfo[itemInfo.value]" label-width="68px">
                <el-select v-if="itemInfo.value === 'feeType'" v-model="itemInfo[itemInfo.value]" filterable clearable>
                  <el-option
                    v-for="itemRate in rateTypeOptions"
                    :key="itemRate.id"
                    :label="itemRate.name"
                ...
                <el-select v-else-if="itemInfo.value === 'carrierId'" v-model="itemInfo[itemInfo.value]" filterable clearable>
                  <el-option
    ...
    <div style="margin-left:80%;margin-top:20px">
      ...
      <el-button type="primary" @click.native="handleUpdateForm">确 定</el-button>
    </div>
  </div>
</template>
...
export default {
  ...
  data() {
    ...
    var validateCW = (rule, value, callback) => {
      if (!parseFloat(this.formData.cubage) && !parseFloat(this.formData.weight)) {
  ...
  mounted() {
    ...
    WaybillApi.getDictionaryWay(1327173901054246912n).then(res => {
      this.deliveryWayOptions = res.data
    }).catch(err => {
      this.$message.error(err)
    })
    // 下单渠道下拉框
  ...
  methods: {
    ...
    changeGetCount() {
      const prams = {}
      Object.assign(prams, this.formData, { placeBillwayTime: '' })
      WaybillApi.getCount(prams).then(res => {
